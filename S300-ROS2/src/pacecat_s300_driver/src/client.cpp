...
public:
    ...
    {
        // 创建客户端
        control_client_ = this->create_client<pacecat_s300_inter::srv::Control>("control_service");
    ...
    rclcpp::Client<pacecat_s300_inter::srv::Control>::SharedFuture send_request(const std::string &func)
    {
        // 创建请求对象
        auto request = std::make_shared<pacecat_s300_inter::srv::Control::Request>();
        request->func = func;
...
private:
    rclcpp::Client<pacecat_s300_inter::srv::Control>::SharedPtr control_client_;
};
